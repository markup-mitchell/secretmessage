...
nnoremap <F5> :let _s=@/|:%s/\s\+$//e|:let @/=_s|
map <F1> 
nnoremap <F2> :set norelativenumber!
...
105
normal! zo
let s:l = 62 - ((0 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
normal! 05|
tabedit ButtonBox.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 32 - ((1 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
